                    ...
                    fixed (T* pTemp = &temp[0])
                    {
                        ...
                        for (int r = 0; r < rowCount; r++)
                        {
                            Array.Copy(
                                ...
                                data, (startIndex * TsizeInBytes) / TsizeInBytes + (r * checkedRect.Width / 4 * fSize) / TsizeInBytes,
                    ...
                    fixed (T* pTemp = &temp[0])
                    {
                        ...
                        for (int r = 0; r < rowCount; r++)
                        {
                            Array.Copy(
                                ...
                                data, (startIndex * TsizeInBytes) / TsizeInBytes + (r * checkedRect.Width * fSize) / TsizeInBytes,
