...
{
    class EffectObjectWriter11 : BinaryWriter
    {
        private readonly int Version;
        private readonly ShaderProfileType _profile;

        public EffectObjectWriter11(Stream output, int version, ShaderProfileType profileType) : base(output)
        {
            System.Diagnostics.Debug.Assert(version == 11);
        ...
        {
            WritePackedInt(shaderVersion.Major);
            WritePackedInt(shaderVersion.Minor);
        }
