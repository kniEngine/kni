...
namespace Microsoft.Xna.Framework.Graphics
{
    ...
    {
        private class EffectReader11 : BinaryReader
        {
            private readonly GraphicsDevice _graphicsDevice;
            private readonly KNIFXHeader _header;

            public EffectReader11(Stream stream, GraphicsDevice graphicsDevice, KNIFXHeader header) : base(stream)
            {
                this._header = header;
            ...
            {
                int major = ReadPackedInt();
                int minor = ReadPackedInt();
