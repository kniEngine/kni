...
dotnet pack src\Xna.Framework.Graphics.PackedVector\Xna.Framework.Graphics.PackedVector.csproj --output NuGetPackages\Output\ /t:Build /p:Configuration=Release
...
dotnet pack src\Xna.Framework.Content\Xna.Framework.Graphics.csproj --output NuGetPackages\Output\ /t:Build /p:Configuration=Release
dotnet pack src\Xna.Framework.Content\Xna.Framework.Audio.csproj --output NuGetPackages\Output\ /t:Build /p:Configuration=Release
