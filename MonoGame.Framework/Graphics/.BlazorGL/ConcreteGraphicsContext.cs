...
namespace Microsoft.Xna.Platform.Graphics
{
    internal sealed class ConcreteGraphicsContext : GraphicsContextStrategy
    {
        ...
        private void PlatformApplyShaders()
        {
            ...
            _vertexConstantBuffers.Strategy.ToConcrete<ConcreteConstantBufferCollection>().Apply(this);
            _pixelConstantBuffers.Strategy.ToConcrete<ConcreteConstantBufferCollection>().Apply(this);
        ...
        internal override IRenderTarget2DStrategy CreateRenderTarget2DStrategy(int width, int height, bool mipMap, int arraySize, bool shared, RenderTargetUsage usage, SurfaceFormat preferredSurfaceFormat, DepthFormat preferredDepthFormat, int preferredMultiSampleCount)
        {
