...
namespace Microsoft.Xna.Framework.Graphics
{
    public partial class RenderTarget2D : IRenderTargetDX11
    {
        ...
        {
            _msSampleDescription = GraphicsDevice.GetSupportedSampleDescription(GraphicsExtensions.ToFormat(this.Format), this.MultiSampleCount);
        ...
        private void GenerateIfRequired()
        {
            ...
            {
                Format = GraphicsExtensions.ToFormat(DepthStencilFormat),
                ArraySize = 1,
                MipLevels = 1,
                Width = width,
                Height = height,
        ...
        internal virtual void ResolveSubresource()
        {
            lock (GraphicsDevice._d3dContext)
            {
                GraphicsDevice._d3dContext.ResolveSubresource(
                    ...
                    GetTexture(),
                    0,
                    GraphicsExtensions.ToFormat(_format));
            }
        }
