...
namespace Microsoft.Xna.Platform.Graphics
{
    internal abstract class ConcreteGraphicsContextGL : GraphicsContextStrategy
    {
        ...
        private static void PlatformApplyTextures(ConcreteGraphicsContextGL cgraphicsContext, ConcreteTextureCollection ctextureCollection)
        {
        ...
        private static void PlatformApplySamplers(ConcreteGraphicsContextGL cgraphicsContext, ConcreteSamplerStateCollection csamplerStateCollection)
        {
            var GL = cgraphicsContext.GL;
