...
namespace Microsoft.Xna.Framework.Graphics
{
    public class GraphicsDevice : IDisposable
    {
        ...
        private void Initialize()
        {
            ...
            _strategy._mainContext.Strategy._vertexConstantBuffers = new ConcreteConstantBufferCollection(16);
            _strategy._mainContext.Strategy._pixelConstantBuffers = new ConcreteConstantBufferCollection(16);
