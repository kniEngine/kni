...
namespace Microsoft.Xna.Framework.Graphics
{
    ...
    public class SwapChainRenderTarget : RenderTarget2D
    {
            ...
            : base(graphicsDevice, width, height, mipMap, QuerySelectedFormat(graphicsDevice, preferredFormat), false, 1, true)
        {
            ...
            _strategyRenderTargetSwapChain = new ConcreteRenderTargetSwapChain(((IPlatformGraphicsDevice)graphicsDevice).Strategy.MainContext.Strategy, width, height, mipMap, usage,
