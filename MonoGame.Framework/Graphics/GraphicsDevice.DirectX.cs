...
namespace Microsoft.Xna.Framework.Graphics
{
    public partial class GraphicsDevice
    {
        ...
        internal void CreateSizeDependentResources()
        {
            ...
            var format = GraphicsExtensions.ToFormat(PresentationParameters.BackBufferFormat);
            ...
            else
            {
                ...
                var desc = new SharpDX.DXGI.SwapChainDescription1()
                {
                    ...
                    BufferCount = 2,
                    SwapEffect = GraphicsExtensions.ToSwapEffect(PresentationParameters.PresentationInterval),
            ...
            {
                var depthFormat = GraphicsExtensions.ToFormat(PresentationParameters.DepthStencilFormat);
